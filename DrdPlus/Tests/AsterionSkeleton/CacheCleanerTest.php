...
use DrdPlus\AsterionSkeleton\CacheCleaner;
use DrdPlus\AsterionSkeleton\Exceptions\CacheRootDirIsNotSafe;
use DrdPlus\AsterionSkeleton\Exceptions\InvalidCacheRootDirSafetyCheck;
