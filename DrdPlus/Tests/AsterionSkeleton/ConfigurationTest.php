...
class ConfigurationTest extends AbstractContentTest
{
    ...
    {
        $this->expectException(\DrdPlus\AsterionSkeleton\Exceptions\InvalidGoogleAnalyticsId::class);
    ...
    {
        $this->expectException(\DrdPlus\AsterionSkeleton\Exceptions\InvalidMenuPosition::class);
        $completeSettings = $this->getSomeCompleteSettings();
    ...
    {
        $this->expectException(\DrdPlus\AsterionSkeleton\Exceptions\MissingShownHomeButtonConfiguration::class);
        $completeSettings = $this->getSomeCompleteSettings();
    ...
    {
        $this->expectException(\DrdPlus\AsterionSkeleton\Exceptions\MissingWebName::class);
        $completeSettings = $this->getSomeCompleteSettings();
    ...
    {
        $this->expectException(\DrdPlus\AsterionSkeleton\Exceptions\TitleSmileyIsNotSet::class);
        $completeSettings = $this->getSomeCompleteSettings();
    ...
    {
        $this->expectException(\DrdPlus\AsterionSkeleton\Exceptions\InvalidEshopUrl::class);
        $settings = $this->getSomeCompleteSettings();
