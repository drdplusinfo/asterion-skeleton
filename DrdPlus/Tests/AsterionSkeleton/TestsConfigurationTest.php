...
class TestsConfigurationTest extends AbstractContentTest
{
    ...
    {
        $this->expectException(\DrdPlus\Tests\AsterionSkeleton\Exceptions\AllowedCalculationPrefixShouldStartByUpperLetter::class);
    ...
    {
        $this->expectException(\DrdPlus\Tests\AsterionSkeleton\Exceptions\InvalidPublicUrl::class);
    ...
    {
        $this->expectException(\DrdPlus\Tests\AsterionSkeleton\Exceptions\PublicUrlShouldUseHttps::class);
