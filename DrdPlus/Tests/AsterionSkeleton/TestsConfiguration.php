...
use DrdPlus\Tests\AsterionSkeleton\Exceptions\InvalidUrl;
use DrdPlus\Tests\AsterionSkeleton\Partials\TestsConfigurationReader;
...
class TestsConfiguration extends StrictObject implements TestsConfigurationReader
{
    ...
    /** @see \DrdPlus\AsterionSkeleton\HtmlHelper::CLASS_CALCULATION */
    public const HAS_MARKED_CONTENT = 'has_marked_content';
    /** @see \DrdPlus\AsterionSkeleton\HtmlHelper::CLASS_CONTENT */
    public const HAS_MARKED_RESULT = 'has_marked_result';
    /** @see \DrdPlus\AsterionSkeleton\HtmlHelper::CLASS_RESULT */
    ...
    /**
     * @param array $values
     * @throws \DrdPlus\Tests\AsterionSkeleton\Exceptions\InvalidLocalUrl
     * @throws \DrdPlus\Tests\AsterionSkeleton\Exceptions\InvalidPublicUrl
     * @throws \DrdPlus\Tests\AsterionSkeleton\Exceptions\PublicUrlShouldUseHttps
     */
     ...
     * @throws \DrdPlus\Tests\AsterionSkeleton\Exceptions\MissingSomeExpectedTableIdsInTestsConfiguration
     */
    ...
    /**
     * @param string $url
     * @throws \DrdPlus\Tests\AsterionSkeleton\Exceptions\InvalidUrl
     */
