...
class UsagePolicy extends StrictObject
{
     ...
     * @param \DrdPlus\AsterionSkeleton\Request $request
     * @param CookiesService $cookiesService
     * @throws \DrdPlus\AsterionSkeleton\Exceptions\ArticleNameCanNotBeEmptyForUsagePolicy
     * @throws \DrdPlus\AsterionSkeleton\Exceptions\ArticleNameShouldBeValidName
     * @throws \DrdPlus\AsterionSkeleton\Exceptions\CookieCanNotBeSet
     */
